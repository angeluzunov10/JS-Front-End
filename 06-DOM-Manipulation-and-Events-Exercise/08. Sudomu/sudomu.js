...
function solve() {
    ...
    let checkParagraphElement = document.querySelector('#check')

    let quickCheckButton = document.querySelector('input[type="submit"]')
    ...
    function checkSudomuEvent(event) {
        ...
        for (let row of rows) {
            let threeTableDatasInputs = Array.from(row.querySelectorAll('td input[type="number"]'))
